    ...
    <public-view>
        <div id="content">
            <n-form ref="formRef" :model="model" :rules="rules">
                ...
                <h1 class="twist-url">TwistURL</h1>
                <h1>Sign In</h1>
...
.logo {
    width: 300px;
    margin-bottom: 20px; /* Reduce the gap after the image */
}
#content {
    display: flex;
    align-items: center;
...
h2 {
    margin-bottom: 5px; /* Adjust spacing between "Welcome to our URL Shortener!" and "TwistURL" */
}

.twist-url {
    color: #4CAF50; /* Change color of TwistURL */
    margin-bottom: 20px; /* Add space after TwistURL */
}
...
h1 {
    text-align: left;
    margin-top: 20px; /* Add space above "Sign In" */
    margin-bottom: 10px; /* Adjust spacing below "Sign In" */
}
</style>
